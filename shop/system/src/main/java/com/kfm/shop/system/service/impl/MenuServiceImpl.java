...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu>
    ...
    public List<Tree<Integer>> treeList(Menu menu) {
        ...
        if (!ObjectUtils.isEmpty(menu.getName()) && !ObjectUtils.isEmpty(menu.getName().trim())) {
         ...
         */
        List<Tree<Integer>> treeNodes = TreeUtil.<Menu, Integer>build(menuList, 0, treeNodeConfig,
